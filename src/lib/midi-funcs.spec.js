...
import { generateVelocity, sendNotes, sendNoteWithDuration } from './midi-funcs';
...
vi.mock( './midi-funcs', async ( importOriginal ) => {
...
describe( 'sendNoteWithDuration', () => {
    it( 'should start and stop a note with the given duration', () => {
        ...
        const selectedOutput = new Object();
        const midiChannel = 1;
        ...
        vi.advanceTimersByTime( durationMs + 10 );
